...
# find First peak inside a list of numbers.
...
""" 
    ...
    and call the function `findFirstPeak()`
"""
arrayPeak = Array(data_sequence)

# getting found peak, and its index from findFirstPeak() function
result = arrayPeak.findFirstPeak()

peak = result[0]
peak_index = result[1]

# we print to see the result
print('--------- Find First Peak Inside An Array ---------')

# printing the data sequence
print('data sequence', '->', BOLD_START, data_sequence, NORM)

# printing the result
print('The result of findFirstPeak is', BOLD_START + ORANGE_COLOR, peak, NORM, 'and its index is',
